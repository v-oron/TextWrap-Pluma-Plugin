...
#
# * 2013-11-04:
#   V_oron <voron.phys@gmail.com>: Replacement "gedit" of "pluma".
#
...
class ToggleTextWrapHelper:
    ...
    def __init__(self, plugin, window):
        ...
        # on gedit/pluma startup but if plugin is enabled during the gedit/pluma session
